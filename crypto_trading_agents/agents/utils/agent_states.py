"""Agent state definitions for the crypto trading agents graph."""
...
class AgentState(MessagesState):
    crypto_of_interest: Annotated[str, "Cryptocurrency we are analyzing"]
    coin_id: Annotated[str, "CoinGecko coin ID for API calls"]
    ...
    final_trade_decision: Annotated[str, "Final decision by Portfolio Manager"]
